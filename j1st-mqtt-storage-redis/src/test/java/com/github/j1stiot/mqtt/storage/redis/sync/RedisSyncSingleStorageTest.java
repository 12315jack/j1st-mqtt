...
import com.github.j1stiot.mqtt.api.internal.PacketId;
import com.github.j1stiot.mqtt.api.internal.Publish;
import com.github.j1stiot.mqtt.storage.redis.util.JSONs;
...
public class RedisSyncSingleStorageTest {
    ...
    public void inFlightTest() throws IOException {
        ...
        InternalMessage<Publish> publish = new InternalMessage<>(
                ...
                new Publish("menuTopic", 123456, JSONs.ObjectMapper.writeValueAsBytes(jn)));
        ...
        jn = JSONs.ObjectMapper.readTree(publish.getPayload().getPayload());
